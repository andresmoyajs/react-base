...
const Shipping = () => {
  ...
  useEffect(() => {
    if (isUpdated) {
      //Navegue hacia la siguiente pasarela de pago - order confirm
      navigate("/order/confirm");
      dispatch(resetUpdateStatus({}));
      //alert.success("Se almacenó la dirección de envió");
    }
  ...
  return (
    <>
      <MetaData titulo={"Información de Envió"} />
      <CheckoutSteps envio />
      <div className="row wrapper">
        <div className="col-10 col-lg-5">
          <form className="shadow-lg" onSubmit={submitHandler}>
            <h1 className="mb-4">Dirección de Envió</h1>
